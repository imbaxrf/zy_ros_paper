...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/zy_ros_paper/zy_ws/src/joint_trajectory_controller/include;/usr/include".split(';') if "/root/zy_ros_paper/zy_ws/src/joint_trajectory_controller/include;/usr/include" != "" else []
